...
export function PwaInstallPrompt() {
  ...
  React.useEffect(() => {
    ...
    // iOS Safari Flow: Show prompt after 2.5s delay
    if (checkIsIosSafari()) {
    ...
    // Android / Chromium Flow: Listen for native beforeinstallprompt
        ...
        <div className="pointer-events-none fixed inset-x-0 bottom-4 z-50 flex justify-center px-4 sm:bottom-6">
          ...
          >
            {!showIosGuide ? (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground mt-0.5 text-xs leading-snug">
                        Fast, full-screen AI workspace with instant home screen
                        access.
                      </p>
                    </div>
                  </div>
              ...
              /* iOS Interactive Step-by-Step Install Guide */
              <div className="flex flex-col gap-3.5">
                ...
                <div className="border-border/50 flex items-center justify-between border-t pt-2.5">
                  <span className="text-muted-foreground flex items-center gap-1 text-[10px]">
                    ...
                    Works 100% offline with full screen
                  </span>
                  <Button
                    size="sm"
                    variant="default"
